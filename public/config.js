...
window.onload = async function() {
    ...
    document.getElementById("descri").value=json[0].cfg_description
    document.getElementById("date").value=json[0].cfg_date
    document.getElementById("name").value=json[0].cfg_name
    document.getElementById("keyact").value=json[0].cfg_key_action
