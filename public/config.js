...
window.onload = async function() {
    ...
    document.getElementById("dowloadfile").innerHTML='<a href="'+json[0].cfg_cfg+'" download="'+json[0].cfg_cfg+'"><button type="button" class="button11" down >Download Now<button></a>'
